...
if (isset($_POST['updatepassword'])) 
{
  ...
  if(isset($_POST['updateprofilepic'])) {
    ...
    $extensions_arr = array("jpg","jpeg","png","gif");
      ...
      $sql = "UPDATE user SET userid=:userid, firstname=:firstname,lastname=:lastname,age=:age,contactno=:contactno,address=:address,email=:email,password=:password,
      gender=:gender,usertype=:usertype,image='".$newfilename."' WHERE userid=:updateid";
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="firstname" required value="<?php echo htmlentities($result->firstname);?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Last Name</label>
                  <input type="text" class="form-control"  name="lastname" required value="<?php echo htmlentities($result->lastname);?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Age</label>
                  <input type="text" class="form-control"  name="age" required value="<?php echo htmlentities($result->age);?>">
                </div>
                <div class="form-group">
                  <label>Gender</label>
