...
<?php  include('D:\PROGRAMMING SOFTWARES\XAMPP\htdocs\WeLift\includes\adminheader.php');      ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        <i class="fa fa-car"></i> View Vehicles
        <small></small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-car"></i> Vehicles </h3>
        
                    
            <div class="box-body">
            <a style="display:inline-block; width:200px; margin-bottom:10px;" href="vehicles-pdf.php" class="btn btn-primary"><i class="fa fa-file-pdf-o" style="padding-right:2px;padding-top:2px;"></i><span>Download/Print Report<span></a>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
               
                <tr style="background-color: #ffff;"> 
                  <th style="width: 8%" style="text-align:center; color: rgb(154, 106, 255);"><i class="fa fa-picture-o"></i></th>
                  <th style="text-align:center; color: rgb(154, 106, 255);" style="width: 11%"><i></i>Vehicle Owner</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);" ><i></i>Color</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);" style="width: 11%"></i>Model</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);"><i></i>Brand</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);"><i></i>Vehicle Type</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);"><i></i>Capacity</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);" ><i></i>Plate Number</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);"><i></i>Official Receipt</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);"><i></i>Certificate of Registration</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);"><i></i>Rate</th>
                  <th style="text-align:center; color: rgb(154, 106, 255);" style="width: 8%"><i></i>Status</th>
                ...
                <tr>
                  ...
                  <td><?php echo htmlentities($result->officialreceipt);?></td>
                  <td><?php echo htmlentities($result->certofregistration);?></td>
                  <td> Php <?php echo htmlentities(number_format((float)$result->rate, 2, '.', ','));?></td>
                  <td style="color:red"><?php echo htmlentities($result->status);?></td>
