...
<?php  include('D:\PROGRAMMING SOFTWARES\XAMPP\htdocs\WeLift\includes\adminheader.php');      ?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="owner.php"><i class="fa fa-circle-o"></i> Vehicle Owner</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        <i class="fa fa-keyboard-o"></i> Manage Vehicle Owners
        <small></small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-user"></i> Vehicle Owners</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #c5c5c5;">
                  <th style="width: 7%;color:#9A6AFF;" align="center"><i class="fa fa-picture-o"></i></th>
                  <th style="width: 11%;color:#9A6AFF;">Vehicle Owner</th>
                ...
                <tbody>
                <?php
                $sql="SELECT * FROM user WHERE usertype = 'Vehicle Owner'";
