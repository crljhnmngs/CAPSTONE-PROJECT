...
<head>
  ...
  <title>Admin - Verify Vehicle Owner</title>
...
<?php  include('D:\PROGRAMMING SOFTWARES\XAMPP\htdocs\WeLift\includes\adminheader.php');      ?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="ownercredential.php">
            <i class="fa fa-users"></i> <span>Vefify Vehicle Owner</span>
          </a>
        </li>
        <li>
          <a href="profile.php">
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        <i class="fa fa-cab"></i> Verify Vehicle Owner
        <small></small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-cab"></i> Vehicle Owner</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #c5c5c5;">
                  <th style="width: 20%;color:#9A6AFF;"> Vehicle Owner</th>
                  ...
                  <th style="color:#9A6AFF;"> Valid ID</th>
                  <th style="width: 11.8%;color:#9A6AFF;"><i class="fa fa-spinner"></i> Status</th>
                </tr>
                </thead>
                <tbody>
                <?php
                $sql="SELECT * FROM user 
                INNER JOIN ownercredentials ON user.userid = ownercredentials.ownerid
                WHERE usertype = 'Vehicle Owner' ";
                ...
                <tr>
                  ...
                  <td align="center">
                    ...
                    <a href="decline.php?userid=<?php echo htmlentities($result->userid)?>&fileid=<?php echo htmlentities($result->fileid)?>"><button class="btn btn-danger btn-xs" type="submit" name="verify" onclick="return confirm('Decline this Account ?')" style="font-size: 15px;font-weight: 500;margin-top:2px;">Decline</button></a>
                  </td>
                  
                  <?php }else if(htmlentities($result->accountstatus) == 'NOT_VERIFIED') { ?>
                    <td align="center" style="font-size: 15px;font-weight: 500;">No ID Uploaded</a></td>
                    <?php }else if(htmlentities($result->accountstatus) == 'VERIFIED') { ?>
                    <td align="center" style="font-size: 15px;font-weight: 500;">VERIFIED</a></td>
                    <?php } ?>
