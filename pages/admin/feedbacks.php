...
<?php  include('D:\PROGRAMMING SOFTWARES\XAMPP\htdocs\WeLift\includes\adminheader.php');      ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 align="center">
        <i class="fa fa-comment"></i> Client Feedbacks
        <small></small>
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-comment"></i> Feedbacks </h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #ffff;"> 
                  ...
                  <th style="text-align:center; width:15%;color:#9A6AFF;"></i>Renter</th>
                  <th style="text-align:center;color:#9A6AFF;"><i></i>Comment</th>
                  <th style="text-align:center;color:#9A6AFF;"><i></i>Rating</th>
                  <th style="text-align:center;color:#9A6AFF;"><i></i>Date</th>
                  <th style="text-align:center;color:#9A6AFF;" ><i></i>Action</th>
                ...
                <?php
                 ...
                 INNER JOIN vehicle ON feedback.vehicleid = vehicle.vehicleid
                ...
                <tr>
                  ...
                  <td><?php echo htmlentities($result->rating);?> Stars</td>
                  <td><?php echo htmlentities(date("F d, Y", strtotime($result->date)));?></td>
                  <td align="center"><a href="deletefeedback.php?feedbackid=<?php echo htmlentities($result->feedbackid)?>"><button type="button" onclick="return confirm('Delete ?')" class="btn btn-danger btn-sm"><i class="fa fa-trash" ></i></button></a></td>
