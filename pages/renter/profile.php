  ...
  $specialChars = preg_match('@[^\w]@', $password);
   ...
   else
   {
    ...
    $extensions_arr2 = array("jpg","jpeg","png","gif");
      ...
      $sql = "INSERT INTO rentercredentials(renterid,validid,validid2)VALUES(:userid,'".$newfilename."','".$newfilename2 ."')";
      $query = $dbh->prepare($sql);  
      $query->bindParam(':userid',$userid,PDO::PARAM_STR);
      $query->execute();
      ...
      $sql3 = "INSERT INTO notification(receiverid,message,header, date)VALUES('1','Renter: $username Uploaded valid ID','renter', '$date')";
...
<head>
  ...
  <title>Client - Manage Account</title>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" onkeydown="return /[a-z]/i.test(event.key)" class="form-control"  name="firstname" required value="<?php echo htmlentities($result->firstname);?>">
                </div>
                <div class="form-group">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6"><label class="labels">Lastname</label><input type="text" disabled class="form-control" value="<?php echo htmlentities($result->lastname);?>" ></div> 
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Age</label><input type="text" disabled class="form-control"  value="<?php echo htmlentities($result->age);?>"></div>
