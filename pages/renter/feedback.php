...
if(!isset($_SESSION['userid']))
  ...
  if (isset($_POST['submit'])) {
    ...
    $renterid=intval($_GET['renterid']);
    $rating=($_POST['rating']);
    $comment=($_POST['comment']);
    $ownerid=($_GET['ownerid']);
    $date = date('y-m-d H:i:s');

    $sql = "INSERT INTO feedback(vehicleid,renterid,rating,comment)VALUES($vehicleid,$renterid,:rating,:comment)";
  ...
  if(isset($_GET['bookingid']))
  {
    ...
    $sql = "UPDATE booking SET bookingstatus = 'TO_CONFIRM' WHERE bookingid = $bookingid";
    $query = $dbh->prepare($sql);
    $query->execute();
...
<?php  include('D:\PROGRAMMING SOFTWARES\XAMPP\htdocs\WeLift\includes\renterheader.php');      ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="rate" align="center">
        <h5 style="margin-top:0px; padding-top:50px;"> Rate your experience </h5>
    </div>

    <div class="rating" align="center" style="margin-top:20px;">
        <input type = "radio" name="rating" value="5" id="star1" required><label for="star1"></label>
    ...
    <textarea placeholder="Leave a review" name="comment" cols="50" rows="10" required></textarea>
    </div>
    ...
    <a href="return.php?ownerid=<?php echo $ownerid ?>"> Skip </a>
    </div>
