...
if(!isset($_SESSION['userid']))
  ...
  else
  {
    ...
    //$latitude = '10.301476981668081';
    //$longitude = '123.97817228456964';
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box"  style="background-color:#fff; height:160px">
            ...
            <?php
               $sql="SELECT COUNT(*) AS total FROM booking
               INNER JOIN rentercredentials ON booking.renterid = rentercredentials.renterid 
               where rentercredentials.renterid = $id AND (bookingstatus = 'RESERVED' OR bookingstatus = 'TO_CONFIRM')";
               $query=$dbh->prepare($sql);
               $query->execute();
               $results=$query->fetchALL(PDO::FETCH_OBJ);
               $cnt=1;   
      ...
      <!-- Main row -->
        ...
        <div class="box-body">
        <div style="text-align:center;font-size:20px;margin-left:130px;"> Nearby Vulcanizing Shops
        <a href="dashboard2.php" style="display:inline-block;margin-bottom:10px;float:right;margin-right:20px;"><button type="submit" class="btn btn-primary"><i class="fa fa-map-marker" style="padding-right:2px;padding-top:2px;"></i>Tourist Spot</button></a>
      </div>
           <table id="example1" class="table table-bordered table-striped">
             <thead>
             <tr style="background-color: #ffff;">
               <th style="width: 50%; color:#9A6AFF;text-align:center;"></i>Shop Name</th>
               <th style="width: 30%; color:#9A6AFF;text-align:center;"></i>Distance</th>
              ...
              * sin( radians( latitude ) ) ) ) AS distance 
              FROM vulcanizing HAVING distance < 2
             ...
             <tr>
              ...
              <td style="height:50px;text-align:center;"><?php echo number_format($result->distance,2);?> Kilometers away</td>
