...
<head>
  ...
  <title>Client - Rental History</title>
            ...
            <option value="12">December</option>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background-color: #c5c5c5;">
                  ...
                  <th style="width: 10%; color:#9A6AFF;">Vehicle Owner</th>
                  ...
                  <th style="color:#9A6AFF;">Vehicle Status</th>
                ...
                <tr">
                  ...
                  <?php if(htmlentities($result->status) == 'AVAILABLE') {?>
                  <td style="height:50px;"><a href="viewvehiclefeedbacks.php?vehicleid=<?php echo htmlentities($result->vehicleid)?>">Available</a></td>
                  <?php } else { ?>
                    <td style="height:50px;"><?php echo htmlentities($result->status);?></td>
                    <?php }?>
                </tr>
                <?php 
                $cnt = 0;
