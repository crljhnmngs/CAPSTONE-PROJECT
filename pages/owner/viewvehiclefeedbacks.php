...
<head>
  ...
  <title>Vehicle Owner - View Feedbacks</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="row" >
     ...
     ?>
                ...
                <a href="managevehicle.php"><button style="margin-left:20%;" type="button" class="btn btn-danger pull-left" data-dismiss="modal"> <i class="fa fa-backward"></i>Back</button></a>
              </div>
          </div>
