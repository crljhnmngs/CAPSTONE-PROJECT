...
if(!isset($_SESSION['userid']))
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO complaints(bookingid,complainantid,complaineeid,complainee,description,status,date)VALUES($bookingid,$id,$renterid,'$complainee',:description,'PENDING','$date1')";
...
<head>
  ...
  <title>Vehicle Owner - Report Client</title>
